...
> 原文：[SymPy 文档](https://docs.sympy.org/latest/modules/functions/special.html)
...
判断 DiracDelta 的参数(args[0])是否是*x*的线性表达式。
...
要在`x=0`处指定不同值的 Heaviside，可以提供第二个参数。使用`Heaviside(x, nan)`会给出一个在`x=0`时评估为 nan 的表达式。
...
[`mathworld.wolfram.com/HeavisideStepFunction.html`](https://mathworld.wolfram.com/HeavisideStepFunction.html)

[R344]

[`dlmf.nist.gov/1.16#iv`](https://dlmf.nist.gov/1.16#iv)
...
[`en.wikipedia.org/wiki/Singularity_function`](https://en.wikipedia.org/wiki/Singularity_function)
...
[`dlmf.nist.gov/5`](https://dlmf.nist.gov/5)

[R348]

[`mathworld.wolfram.com/GammaFunction.html`](https://mathworld.wolfram.com/GammaFunction.html)

[R349]

[`functions.wolfram.com/GammaBetaErf/Gamma/`](https://functions.wolfram.com/GammaBetaErf/Gamma/)
...
[`en.wikipedia.org/wiki/Gamma_function`](https://en.wikipedia.org/wiki/Gamma_function)
...
[`mathworld.wolfram.com/LogGammaFunction.html`](https://mathworld.wolfram.com/LogGammaFunction.html)

[R353]

[`functions.wolfram.com/GammaBetaErf/LogGamma/`](https://functions.wolfram.com/GammaBetaErf/LogGamma/)
...
[`en.wikipedia.org/wiki/Polygamma_function`](https://en.wikipedia.org/wiki/Polygamma_function)

[R355]

[`mathworld.wolfram.com/PolygammaFunction.html`](https://mathworld.wolfram.com/PolygammaFunction.html)

[R356]

[`functions.wolfram.com/GammaBetaErf/PolyGamma/`](https://functions.wolfram.com/GammaBetaErf/PolyGamma/)

[R357]

[`functions.wolfram.com/GammaBetaErf/PolyGamma2/`](https://functions.wolfram.com/GammaBetaErf/PolyGamma2/)
...
[`en.wikipedia.org/wiki/Digamma_function`](https://en.wikipedia.org/wiki/Digamma_function)

[R360]

[`mathworld.wolfram.com/DigammaFunction.html`](https://mathworld.wolfram.com/DigammaFunction.html)
...
[`en.wikipedia.org/wiki/Trigamma_function`](https://en.wikipedia.org/wiki/Trigamma_function)

[R363]

[`mathworld.wolfram.com/TrigammaFunction.html`](https://mathworld.wolfram.com/TrigammaFunction.html)
...
[`en.wikipedia.org/wiki/Incomplete_gamma_function#Upper_incomplete_gamma_function`](https://en.wikipedia.org/wiki/Incomplete_gamma_function#Upper_incomplete_gamma_function)
...
[`dlmf.nist.gov/8`](https://dlmf.nist.gov/8)

[R368]

[`functions.wolfram.com/GammaBetaErf/Gamma2/`](https://functions.wolfram.com/GammaBetaErf/Gamma2/)

[R369]

[`functions.wolfram.com/GammaBetaErf/Gamma3/`](https://functions.wolfram.com/GammaBetaErf/Gamma3/)

[R370]

[`en.wikipedia.org/wiki/Exponential_integral#Relation_with_other_functions`](https://en.wikipedia.org/wiki/Exponential_integral#Relation_with_other_functions)
...
[`en.wikipedia.org/wiki/Incomplete_gamma_function#Lower_incomplete_gamma_function`](https://en.wikipedia.org/wiki/Incomplete_gamma_function#Lower_incomplete_gamma_function)
...
[`en.wikipedia.org/wiki/Multivariate_gamma_function`](https://en.wikipedia.org/wiki/Multivariate_gamma_function)
...
[`en.wikipedia.org/wiki/Beta_function`](https://en.wikipedia.org/wiki/Beta_function)

[R378]

[`mathworld.wolfram.com/BetaFunction.html`](https://mathworld.wolfram.com/BetaFunction.html)

[R379]

[`dlmf.nist.gov/5.12`](https://dlmf.nist.gov/5.12)  ## 误差函数与菲涅尔积分
...
[`dlmf.nist.gov/7`](https://dlmf.nist.gov/7)

[R382]

[`mathworld.wolfram.com/Erf.html`](https://mathworld.wolfram.com/Erf.html)

[R383]

[`functions.wolfram.com/GammaBetaErf/Erf`](https://functions.wolfram.com/GammaBetaErf/Erf)
...
[`mathworld.wolfram.com/Erfc.html`](https://mathworld.wolfram.com/Erfc.html)

[R387]

[`functions.wolfram.com/GammaBetaErf/Erfc`](https://functions.wolfram.com/GammaBetaErf/Erfc)
...
[`mathworld.wolfram.com/Erfi.html`](https://mathworld.wolfram.com/Erfi.html)

[R390]

[`functions.wolfram.com/GammaBetaErf/Erfi`](https://functions.wolfram.com/GammaBetaErf/Erfi)
...
[`functions.wolfram.com/GammaBetaErf/Erf2/`](https://functions.wolfram.com/GammaBetaErf/Erf2/)
...
[`en.wikipedia.org/wiki/Error_function#Inverse_functions`](https://en.wikipedia.org/wiki/Error_function#Inverse_functions)

[R393]

[`functions.wolfram.com/GammaBetaErf/InverseErf/`](https://functions.wolfram.com/GammaBetaErf/InverseErf/)
...
[`functions.wolfram.com/GammaBetaErf/InverseErfc/`](https://functions.wolfram.com/GammaBetaErf/InverseErfc/)
...
[`functions.wolfram.com/GammaBetaErf/InverseErf2/`](https://functions.wolfram.com/GammaBetaErf/InverseErf2/)
...
[`en.wikipedia.org/wiki/Fresnel_integral`](https://en.wikipedia.org/wiki/Fresnel_integral)
...
[`mathworld.wolfram.com/FresnelIntegrals.html`](https://mathworld.wolfram.com/FresnelIntegrals.html)

[R400]

[`functions.wolfram.com/GammaBetaErf/FresnelS`](https://functions.wolfram.com/GammaBetaErf/FresnelS)
...
[`functions.wolfram.com/GammaBetaErf/FresnelC`](https://functions.wolfram.com/GammaBetaErf/FresnelC)
...
[`dlmf.nist.gov/6.6`](https://dlmf.nist.gov/6.6)

[R408]

[`en.wikipedia.org/wiki/Exponential_integral`](https://en.wikipedia.org/wiki/Exponential_integral)

[R409]

Abramowitz & Stegun, section 5: [`web.archive.org/web/20201128173312/http://people.math.sfu.ca/~cbm/aands/page_228.htm`](https://web.archive.org/web/20201128173312/http://people.math.sfu.ca/~cbm/aands/page_228.htm)
...
[`dlmf.nist.gov/8.19`](https://dlmf.nist.gov/8.19)

[R411]

[`functions.wolfram.com/GammaBetaErf/ExpIntegralE/`](https://functions.wolfram.com/GammaBetaErf/ExpIntegralE/)
...
[`dlmf.nist.gov/6`](https://dlmf.nist.gov/6)

[R416]

[Soldner 常数](https://mathworld.wolfram.com/SoldnersConstant.html)。
...
[`en.wikipedia.org/wiki/Logarithmic_integral`](https://en.wikipedia.org/wiki/Logarithmic_integral)

[R418]

[`mathworld.wolfram.com/LogarithmicIntegral.html`](https://mathworld.wolfram.com/LogarithmicIntegral.html)
...
[`en.wikipedia.org/wiki/Trigonometric_integral`](https://en.wikipedia.org/wiki/Trigonometric_integral)
...
[`en.wikipedia.org/wiki/Bessel_function`](https://en.wikipedia.org/wiki/Bessel_function)

[R427]

[`functions.wolfram.com/Bessel-TypeFunctions/BesselJ/`](https://functions.wolfram.com/Bessel-TypeFunctions/BesselJ/)
...
[`functions.wolfram.com/Bessel-TypeFunctions/BesselY/`](https://functions.wolfram.com/Bessel-TypeFunctions/BesselY/)
...
[`functions.wolfram.com/Bessel-TypeFunctions/BesselI/`](https://functions.wolfram.com/Bessel-TypeFunctions/BesselI/)
...
[`functions.wolfram.com/Bessel-TypeFunctions/BesselK/`](https://functions.wolfram.com/Bessel-TypeFunctions/BesselK/)
...
[`functions.wolfram.com/Bessel-TypeFunctions/HankelH1/`](https://functions.wolfram.com/Bessel-TypeFunctions/HankelH1/)
...
[`functions.wolfram.com/Bessel-TypeFunctions/HankelH2/`](https://functions.wolfram.com/Bessel-TypeFunctions/HankelH2/)
...
其中系数 \(f_n(z)\) 可以通过`sympy.polys.orthopolys.spherical_bessel_fn()` 获得。
...
[`dlmf.nist.gov/10.47`](https://dlmf.nist.gov/10.47)
...
[`en.wikipedia.org/wiki/Marcum_Q-function`](https://en.wikipedia.org/wiki/Marcum_Q-function)
...
[`en.wikipedia.org/wiki/Airy_function`](https://en.wikipedia.org/wiki/Airy_function)

[R438]

[`dlmf.nist.gov/9`](https://dlmf.nist.gov/9)

[R439]

[`encyclopediaofmath.org/wiki/Airy_functions`](https://encyclopediaofmath.org/wiki/Airy_functions)

[R440]

[`mathworld.wolfram.com/AiryFunctions.html`](https://mathworld.wolfram.com/AiryFunctions.html)
...
在给定结点*knots*处的阶为*d*的第*n*个 B 样条。
...
B 样条是阶为*d*的分段多项式。它们定义在结点的集合上，这些结点是整数或浮点数序列。
...
对于给定的`(d, knots)`，定义了`len(knots)-d-1`个 B 样条，其由索引`n`（从 0 开始）索引。
...
[`en.wikipedia.org/wiki/B-spline`](https://en.wikipedia.org/wiki/B-spline)
...
此函数返回一个多段多项式列表，这些多项式是给定结点*knots*的度数为*d*的`len(knots)-d-1`个 B 样条。该函数为不同的*n*值调用`bspline_basis(d, knots, n, x)`。
...
[`dlmf.nist.gov/25.11`](https://dlmf.nist.gov/25.11)

[R455]

[`en.wikipedia.org/wiki/Hurwitz_zeta_function`](https://en.wikipedia.org/wiki/Hurwitz_zeta_function)
...
[`en.wikipedia.org/wiki/Dirichlet_eta_function`](https://en.wikipedia.org/wiki/Dirichlet_eta_function)

[R457]

彼得·鲁施尼，“伯努利函数简介”，[`arxiv.org/abs/2009.06743`](https://arxiv.org/abs/2009.06743)
...
[`dlmf.nist.gov/25.14`](https://dlmf.nist.gov/25.14)

[R460]

[`en.wikipedia.org/wiki/Lerch_transcendent`](https://en.wikipedia.org/wiki/Lerch_transcendent)
...
[`en.wikipedia.org/wiki/Stieltjes_constants`](https://en.wikipedia.org/wiki/Stieltjes_constants)
...
[`en.wikipedia.org/wiki/Meijer_G-function`](https://en.wikipedia.org/wiki/Meijer_G-function)
...
[`en.wikipedia.org/wiki/Appell_series`](https://en.wikipedia.org/wiki/Appell_series)

[R467]

[`functions.wolfram.com/HypergeometricFunctions/AppellF1/`](https://functions.wolfram.com/HypergeometricFunctions/AppellF1/)
...
[`en.wikipedia.org/wiki/Elliptic_integrals`](https://en.wikipedia.org/wiki/Elliptic_integrals)

[R469]

[`functions.wolfram.com/EllipticIntegrals/EllipticK`](https://functions.wolfram.com/EllipticIntegrals/EllipticK)
...
[`functions.wolfram.com/EllipticIntegrals/EllipticF`](https://functions.wolfram.com/EllipticIntegrals/EllipticF)
...
[`functions.wolfram.com/EllipticIntegrals/EllipticE2`](https://functions.wolfram.com/EllipticIntegrals/EllipticE2)

[R474]

[`functions.wolfram.com/EllipticIntegrals/EllipticE`](https://functions.wolfram.com/EllipticIntegrals/EllipticE)
...
[`functions.wolfram.com/EllipticIntegrals/EllipticPi3`](https://functions.wolfram.com/EllipticIntegrals/EllipticPi3)

[R477]

[`functions.wolfram.com/EllipticIntegrals/EllipticPi`](https://functions.wolfram.com/EllipticIntegrals/EllipticPi)  ## Mathieu 函数
...
[`en.wikipedia.org/wiki/Mathieu_function`](https://en.wikipedia.org/wiki/Mathieu_function)

[R479]

[`dlmf.nist.gov/28`](https://dlmf.nist.gov/28)

[R480]

[`mathworld.wolfram.com/MathieuFunction.html`](https://mathworld.wolfram.com/MathieuFunction.html)

[R481]

[`functions.wolfram.com/MathieuandSpheroidalFunctions/MathieuS/`](https://functions.wolfram.com/MathieuandSpheroidalFunctions/MathieuS/)
...
[`functions.wolfram.com/MathieuandSpheroidalFunctions/MathieuC/`](https://functions.wolfram.com/MathieuandSpheroidalFunctions/MathieuC/)
...
[`functions.wolfram.com/MathieuandSpheroidalFunctions/MathieuSPrime/`](https://functions.wolfram.com/MathieuandSpheroidalFunctions/MathieuSPrime/)
...
[`functions.wolfram.com/MathieuandSpheroidalFunctions/MathieuCPrime/`](https://functions.wolfram.com/MathieuandSpheroidalFunctions/MathieuCPrime/)  ## 正交多项式
...
[`en.wikipedia.org/wiki/Jacobi_polynomials`](https://en.wikipedia.org/wiki/Jacobi_polynomials)

[R495]

[`mathworld.wolfram.com/JacobiPolynomial.html`](https://mathworld.wolfram.com/JacobiPolynomial.html)

[R496]

[`functions.wolfram.com/Polynomials/JacobiP/`](https://functions.wolfram.com/Polynomials/JacobiP/)
...
[`en.wikipedia.org/wiki/Gegenbauer_polynomials`](https://en.wikipedia.org/wiki/Gegenbauer_polynomials)

[R501]

[`mathworld.wolfram.com/GegenbauerPolynomial.html`](https://mathworld.wolfram.com/GegenbauerPolynomial.html)

[R502]

[`functions.wolfram.com/Polynomials/GegenbauerC3/`](https://functions.wolfram.com/Polynomials/GegenbauerC3/)
...
[`en.wikipedia.org/wiki/Chebyshev_polynomial`](https://en.wikipedia.org/wiki/Chebyshev_polynomial)的[切比雪夫多项式](https://en.wikipedia.org/wiki/Chebyshev_polynomial)

[R504]

[`mathworld.wolfram.com/ChebyshevPolynomialoftheFirstKind.html`](https://mathworld.wolfram.com/ChebyshevPolynomialoftheFirstKind.html)

[R505]

[`mathworld.wolfram.com/ChebyshevPolynomialoftheSecondKind.html`](https://mathworld.wolfram.com/ChebyshevPolynomialoftheSecondKind.html)

[R506]

[`functions.wolfram.com/Polynomials/ChebyshevT/`](https://functions.wolfram.com/Polynomials/ChebyshevT/)

[R507]

[`functions.wolfram.com/Polynomials/ChebyshevU/`](https://functions.wolfram.com/Polynomials/ChebyshevU/)
...
[`en.wikipedia.org/wiki/Chebyshev_polynomial`](https://en.wikipedia.org/wiki/Chebyshev_polynomial)  
...
[`en.wikipedia.org/wiki/Legendre_polynomial`](https://en.wikipedia.org/wiki/Legendre_polynomial)

[R514]

[`mathworld.wolfram.com/LegendrePolynomial.html`](https://mathworld.wolfram.com/LegendrePolynomial.html)

[R515]

[`functions.wolfram.com/Polynomials/LegendreP/`](https://functions.wolfram.com/Polynomials/LegendreP/)

[R516]

[`functions.wolfram.com/Polynomials/LegendreP2/`](https://functions.wolfram.com/Polynomials/LegendreP2/)
...
[`en.wikipedia.org/wiki/Associated_Legendre_polynomials`](https://en.wikipedia.org/wiki/Associated_Legendre_polynomials)
...
[`en.wikipedia.org/wiki/Hermite_polynomial`](https://en.wikipedia.org/wiki/Hermite_polynomial)

[R522]

[`mathworld.wolfram.com/HermitePolynomial.html`](https://mathworld.wolfram.com/HermitePolynomial.html)

[R523]

[`functions.wolfram.com/Polynomials/HermiteH/`](https://functions.wolfram.com/Polynomials/HermiteH/)
...
[`en.wikipedia.org/wiki/Laguerre_polynomial`](https://en.wikipedia.org/wiki/Laguerre_polynomial)

[R527]

[`mathworld.wolfram.com/LaguerrePolynomial.html`](https://mathworld.wolfram.com/LaguerrePolynomial.html)

[R528]

[`functions.wolfram.com/Polynomials/LaguerreL/`](https://functions.wolfram.com/Polynomials/LaguerreL/)

[R529]

[`functions.wolfram.com/Polynomials/LaguerreL3/`](https://functions.wolfram.com/Polynomials/LaguerreL3/)
...
> 任意表达式。对于`alpha=0`，将生成常规的 Laguerre 多项式。
...
[`en.wikipedia.org/wiki/Laguerre_polynomial#Generalized_Laguerre_polynomials`](https://en.wikipedia.org/wiki/Laguerre_polynomial#Generalized_Laguerre_polynomials)

[R531]

[`mathworld.wolfram.com/AssociatedLaguerrePolynomial.html`](https://mathworld.wolfram.com/AssociatedLaguerrePolynomial.html)
...
[`en.wikipedia.org/wiki/Spherical_harmonics`](https://en.wikipedia.org/wiki/Spherical_harmonics)

[R535]

[`mathworld.wolfram.com/SphericalHarmonic.html`](https://mathworld.wolfram.com/SphericalHarmonic.html)

[R536]

[`functions.wolfram.com/Polynomials/SphericalHarmonicY/`](https://functions.wolfram.com/Polynomials/SphericalHarmonicY/)

[R537]

[`dlmf.nist.gov/14.30`](https://dlmf.nist.gov/14.30)
