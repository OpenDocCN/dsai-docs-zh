...
+   向[`scipy.optimize.curve_fit`](../reference/generated/scipy.optimize.curve_fit.html#scipy.optimize.curve_fit "scipy.optimize.curve_fit")添加了`full_output`参数，以输出额外的解决方案信息。
...
+   SciPy 现已提供了一份针对开发者的草案 CLI，利用了 `doit`、`click` 和 `rich-click` 工具。更多详情请参见 [gh-15959]([https://github.com/scipy/scipy/pull/15959](https://github.com/scipy/scipy/pull/15959))。
...
+   [#2993](https://github.com/scipy/scipy/issues/2993): optimize.approx_fprime和jacobians
...
+   [#15822](https://github.com/scipy/scipy/pull/15822): DEP：从interpolate.PPoly.extend中删除`right`
...
+   [#15953](https://github.com/scipy/scipy/pull/15953): 文档：添加meson文档以在并行和优化中使用gcc、clang构建

+   [#15955](https://github.com/scipy/scipy/pull/15955): 错误修复：修正`D_IIR_forback(1,2)`的签名

+   [#15959](https://github.com/scipy/scipy/pull/15959): 增强：SciPy的开发者CLI

+   [#15965](https://github.com/scipy/scipy/pull/15965): 维护：stats：确保`rv_continuous._fitstart`形状…

+   [#15968](https://github.com/scipy/scipy/pull/15968): 错误修复：修正dev.py中的调试和覆盖参数

+   [#15970](https://github.com/scipy/scipy/pull/15970): 构建：为`matfuncs_expm`指定`cython_lapack`依赖项

+   [#15973](https://github.com/scipy/scipy/pull/15973): 文档：在integrate.nquad中添加公式渲染

+   [#15981](https://github.com/scipy/scipy/pull/15981): 增强：optimize：添加Newton-TFQMR方法并为Newton-Krylov添加一些测试

+   [#15982](https://github.com/scipy/scipy/pull/15982): 基准测试：stats：分布内存和CDF/PPF往返基准测试

+   [#15983](https://github.com/scipy/scipy/pull/15983): 测试：sparse.linalg：为参数`show`添加测试

+   [#15991](https://github.com/scipy/scipy/pull/15991): 测试：修复np.kron矩阵问题。

+   [#15992](https://github.com/scipy/scipy/pull/15992): 文档：修正返回部分中的`degrees`参数

+   [#15997](https://github.com/scipy/scipy/pull/15997): 维护：integrate：为QUADPACK Fortran源添加`recursive`

+   [#15998](https://github.com/scipy/scipy/pull/15998): 错误修复：修复yeojohnson当转换数据方差为零时

+   [#15999](https://github.com/scipy/scipy/pull/15999): 维护：将doit.db.db添加到gitignore

+   [#16004](https://github.com/scipy/scipy/pull/16004): 维护：将MaximumFlowResult.residual重命名为flow
...
+   [#16012](https://github.com/scipy/scipy/pull/16012): 文档：修复损坏的链接并在贡献指南中添加Python标头

+   [#16015](https://github.com/scipy/scipy/pull/16015): 删除：为淘汰residual而提升版本。

+   [#16018](https://github.com/scipy/scipy/pull/16018): 文档：修正从源代码构建Arch Linux本地依赖项的说明

+   [#16019](https://github.com/scipy/scipy/pull/16019): 文档：修正快速入门指南中的conda环境名称 [跳过CI]

+   [#16021](https://github.com/scipy/scipy/pull/16021): 文档：basinhopping文档中的拼写错误

+   [#16024](https://github.com/scipy/scipy/pull/16024): CI：取消固定pytest和pytest-xdist版本

+   [#16026](https://github.com/scipy/scipy/pull/16026): 错误修复：允许`spsolve_triangular`处理具有…的矩阵

+   [#16029](https://github.com/scipy/scipy/pull/16029): 错误修复：修正meson-info文件错误并添加更多信息异常
...
+   [#16303](https://github.com/scipy/scipy/pull/16303): 维护：撤销添加multivariate_beta。
...
+   [#16316](https://github.com/scipy/scipy/pull/16316): 发布：更新版本切换器至1.8.1。

+   [#16321](https://github.com/scipy/scipy/pull/16321): 文档：修正错误的弃用标签格式。

+   [#16326](https://github.com/scipy/scipy/pull/16326): 发布：更新版本切换器至1.9。

+   [#16329](https://github.com/scipy/scipy/pull/16329): 维护：1.9.x的git安全补丁。

+   [#16339](https://github.com/scipy/scipy/pull/16339): 维护，测试：提升_axis_nan_policy_test的公差。

+   [#16341](https://github.com/scipy/scipy/pull/16341): 构建：更新Pythran要求到0.11.0，以支持Clang >=13。

+   [#16353](https://github.com/scipy/scipy/pull/16353): 维护：版本边界1.9.0rc1。

+   [#16360](https://github.com/scipy/scipy/pull/16360): 维护，测试：为theilslopes增加警告抑制。

+   [#16361](https://github.com/scipy/scipy/pull/16361): 维护：SCIPY_USE_PROPACK。

+   [#16370](https://github.com/scipy/scipy/pull/16370): 维护：更新Boost子模块以包含Cygwin修复。

+   [#16374](https://github.com/scipy/scipy/pull/16374): 维护：更新pydata-sphinx主题。

+   [#16379](https://github.com/scipy/scipy/pull/16379): 文档：深色主题CSS调整。

+   [#16390](https://github.com/scipy/scipy/pull/16390): 测试，维护：调整32位系统下HiGHS的xfail标记。

+   [#16393](https://github.com/scipy/scipy/pull/16393): 维护：使用正确的类型进行逐元素比较。

+   [#16414](https://github.com/scipy/scipy/pull/16414): 错误修复：空间：处理HalfspaceIntersection中的整数数组。

+   [#16420](https://github.com/scipy/scipy/pull/16420): 维护：1.9.0的下一轮后期补丁。

+   [#16422](https://github.com/scipy/scipy/pull/16422): 测试：修复与numpy相关的强制转换警告问题...

+   [#16427](https://github.com/scipy/scipy/pull/16427): 维护：stats.shapiro：不要直接修改输入内容。

+   [#16429](https://github.com/scipy/scipy/pull/16429): 维护：stats.mode：恢复gh-15423。

+   [#16436](https://github.com/scipy/scipy/pull/16436): 文档：optimize：明确标记已弃用的linprog方法。

+   [#16444](https://github.com/scipy/scipy/pull/16444): 错误修复：修复messagestream.pyx中无法打开临时文件的问题（#8850）。

+   [#16451](https://github.com/scipy/scipy/pull/16451): 维护：几个1.9.0后期补丁。

+   [#16453](https://github.com/scipy/scipy/pull/16453): 文档：编辑1.9.0-notes.rst。

+   [#16457](https://github.com/scipy/scipy/pull/16457): 测试：跳过32位系统下的test_pdist_correlation_iris_nonC。

+   [#16458](https://github.com/scipy/scipy/pull/16458): 维护：1.9.0的后期补丁。

+   [#16473](https://github.com/scipy/scipy/pull/16473): 发布：更新1.9.0版本说明。

+   [#16482](https://github.com/scipy/scipy/pull/16482): 文档：更新optimize.linprog的Returns部分。

+   [#16484](https://github.com/scipy/scipy/pull/16484): 维护：从README.rst中删除原始html

+   [#16485](https://github.com/scipy/scipy/pull/16485): 构建：修复f2py模板解析中的警告

+   [#16493](https://github.com/scipy/scipy/pull/16493): 构建：通过`.gitattributes`清理分发中不需要的文件

+   [#16507](https://github.com/scipy/scipy/pull/16507): 发布：进一步调整sdist内容

+   [#16512](https://github.com/scipy/scipy/pull/16512): [1.9] 维护：在Windows上跳过complex128 propack测试

+   [#16514](https://github.com/scipy/scipy/pull/16514): 文档：正确反映Windows轮子的构建位置

+   [#16526](https://github.com/scipy/scipy/pull/16526): 维护：1.9.0rc2 回溯

+   [#16530](https://github.com/scipy/scipy/pull/16530): 维护：修复numpy 1.23中的umfpack测试失败

+   [#16539](https://github.com/scipy/scipy/pull/16539): 维护：更多1.9.0rc2回溯

+   [#16541](https://github.com/scipy/scipy/pull/16541): 构建：修复在使用符号可见性构建_lsap时的回归

+   [#16549](https://github.com/scipy/scipy/pull/16549): 构建：修复pyproject.toml中macOS arm64的过时要求

+   [#16551](https://github.com/scipy/scipy/pull/16551): 构建：修复`special/_round.h`中的`__STDC_VERSION__`检查

+   [#16553](https://github.com/scipy/scipy/pull/16553): 构建：为过新的Python版本提供明确的错误信息

+   [#16556](https://github.com/scipy/scipy/pull/16556): 文档：对1.9.0版本发布说明进行小调整

+   [#16563](https://github.com/scipy/scipy/pull/16563): 文档：反映MSVC最低工具链要求

+   [#16570](https://github.com/scipy/scipy/pull/16570): 维护：在1.9.0rc3之前进行回溯

+   [#16572](https://github.com/scipy/scipy/pull/16572): 维护：更新捆绑许可证以删除scipy-sphinx-theme

+   [#16581](https://github.com/scipy/scipy/pull/16581): 维护：stats：修复偏度/峰度空1d输入

+   [#16586](https://github.com/scipy/scipy/pull/16586): 维护：stats.truncnorm：改进CDF的准确性/速度

+   [#16593](https://github.com/scipy/scipy/pull/16593): 测试：stats：替换TestTruncnorm::test_moments
...
+   [#16622](https://github.com/scipy/scipy/pull/16622): 增强：修复：更新HiGHS子模块以解决MIP不可行性...

+   [#16638](https://github.com/scipy/scipy/pull/16638): 文档：更新使用Meson构建的文档

+   [#16664](https://github.com/scipy/scipy/pull/16664): 维护：stats._axis_nan_policy：保留掩码数组的dtype...

+   [#16671](https://github.com/scipy/scipy/pull/16671): 构建：更新`meson`和`meson-python`版本至1.9.0...

+   [#16684](https://github.com/scipy/scipy/pull/16684): 维护：optimize.linprog：确保整数性可以是一个数组

+   [#16688](https://github.com/scipy/scipy/pull/16688): 文档：几个mailmap更新
