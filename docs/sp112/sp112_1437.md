...
+   [SciPy 1.5.0 发布说明](#scipy-1-5-0-release-notes)
    ...
    +   [1.5.0 的已关闭问题](#issues-closed-for-1-5-0)
...
添加了 [`scipy.spatial.geometric_slerp`](../reference/generated/scipy.spatial.geometric_slerp.html#scipy.spatial.geometric_slerp "scipy.spatial.geometric_slerp")，允许在 n-球面上进行几何球形线性插值
...
拉普拉斯分布的 *fit* 方法，[`scipy.stats.laplace`](../reference/generated/scipy.stats.laplace.html#scipy.stats.laplace "scipy.stats.laplace")，现在使用参数的最大似然估计的解析公式。
...
## [`scipy.linalg`](../reference/linalg.html#module-scipy.linalg "scipy.linalg") 的更改
...
+   [#11311](https://github.com/scipy/scipy/pull/11311): DOC: 在_cluster.hierarchy.fclusterdata_中指定度量标准的自定义可调用选项
...
+   [#11520](https://github.com/scipy/scipy/pull/11520): BUG：如果传入nan，则使special.eval_gegenbauer返回nan
...
+   [#11589](https://github.com/scipy/scipy/pull/11589): 维护：移除Python 2的兼容性处理
...
+   [#11872](https://github.com/scipy/scipy/pull/11872): 错误修复：避免在scipy.optimize.optimize.MemoizeJac中重新计算。
...
+   [#12160](https://github.com/scipy/scipy/pull/12160): 错误修复：修复M_PI

+   [#12168](https://github.com/scipy/scipy/pull/12168): 文档：在文档发布中添加一个过时版本检查的JavaScript

+   [#12171](https://github.com/scipy/scipy/pull/12171): CI，维护：Azure OpenBLAS驱动程序翻转

+   [#12172](https://github.com/scipy/scipy/pull/12172): 增强：Powell最小化方法的边界

+   [#12175](https://github.com/scipy/scipy/pull/12175): 构建：支持更多Fortran编译器用于ilp64和宏扩展...

+   [#12179](https://github.com/scipy/scipy/pull/12179): 错误修复：stats：部分分布不接受列表作为参数。

+   [#12180](https://github.com/scipy/scipy/pull/12180): 维护：在SphericalVoronoi测试中删除了冗余导入

+   [#12181](https://github.com/scipy/scipy/pull/12181): 文档：对于versionwarning，不使用$.getScript

+   [#12182](https://github.com/scipy/scipy/pull/12182): 维护：在SphericalVoronoi中超球面上的随机抽样…

+   [#12194](https://github.com/scipy/scipy/pull/12194): 维护：模块和示例清理以进行文档构建

+   [#12202](https://github.com/scipy/scipy/pull/12202): 增强：从Anaconda下载发布轮子的工具

+   [#12210](https://github.com/scipy/scipy/pull/12210): 移除py.typed标记（至少在发布中）

+   [#12217](https://github.com/scipy/scipy/pull/12217): 错误修复：stats：修复median_abs_deviation中的极端情况处理。

+   [#12223](https://github.com/scipy/scipy/pull/12223): 错误修复：stats：wilcoxon对某些输入返回p > 1。

+   [#12227](https://github.com/scipy/scipy/pull/12227): 构建：在构建rectangular_lsap时设置macOS最低版本

+   [#12229](https://github.com/scipy/scipy/pull/12229): 维护：tools/gh_lists.py：修复HTTP头大小写敏感性问题

+   [#12236](https://github.com/scipy/scipy/pull/12236): 文档：修复1.5.0-notes.rst中的一些语法错误。

+   [#12276](https://github.com/scipy/scipy/pull/12276): 测试：跳过*test_heequb*，它偶尔失败。

+   [#12285](https://github.com/scipy/scipy/pull/12285): CI：将travis arm64运行拆分为两部分

+   [#12317](https://github.com/scipy/scipy/pull/12317): 错误修复：*Rotation*乘法中防止错误累积

+   [#12318](https://github.com/scipy/scipy/pull/12318): 错误修复：稀疏：避免np.prod在check_shape中溢出

+   [#12319](https://github.com/scipy/scipy/pull/12319): 错误修复：使cobyla线程安全

+   [#12335](https://github.com/scipy/scipy/pull/12335): 维护：解决Sphinx的一个bug
