...
> 原文链接：[https://docs.scipy.org/doc/scipy-1.12.0/reference/generated/scipy.stats.loguniform.html#scipy.stats.loguniform](https://docs.scipy.org/doc/scipy-1.12.0/reference/generated/scipy.stats.loguniform.html#scipy.stats.loguniform)
...
作为[`rv_continuous`](scipy.stats.rv_continuous.html#scipy.stats.rv_continuous "scipy.stats.rv_continuous")类的一个实例，[`loguniform`](#scipy.stats.loguniform "scipy.stats.loguniform")对象继承了一系列通用方法（下面列出了完整列表），并针对这种特定分布增加了细节。
...
![../../_images/scipy-stats-loguniform-1_00_00.png](../Images/240781e684633c94efdb8f27eeed8442.png)

这并不显示`0.01`、`0.1`和`1`的相等概率。当x轴对数缩放时效果最佳：
...
![../../_images/scipy-stats-loguniform-1_01_00.png](../Images/83ec373df4c30f9fdc1ba3e10304a7b4.png)
...
![../../_images/scipy-stats-loguniform-1_02_00.png](../Images/58388485dbd5a2f9d5b2606b1ae78820.png)
