...
> 原文：[`pandas.pydata.org/docs/reference/api/pandas.DataFrame.rmod.html`](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.rmod.html)
...
等效于`other % dataframe`，但支持在输入中的一个缺失数据时替换填充值的支持。使用反向版本 mod。
