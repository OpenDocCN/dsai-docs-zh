...
> 原文链接：[https://docs.sympy.org/latest/modules/physics/mechanics/api/part_bod.html](https://docs.sympy.org/latest/modules/physics/mechanics/api/part_bod.html)
...
此函数返回粒子和/或刚体系统的拉格朗日量。这样系统的拉格朗日量等于其组成部分的动能和势能之差。如果T和V分别是系统的动能和势能，则其拉格朗日量L定义为
