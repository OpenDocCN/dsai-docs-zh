...
创建带有稀疏内部表示的 [`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix"):
...
对于非域环也可以计算零空间。如果环不是域，则不使用除法。在这种情况下将`divide_last`设置为True会引发错误：
...
[`to_sdm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_sdm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_sdm"), [`to_dense`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dense "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dense"), [`sympy.polys.matrices.ddm.DDM.to_sdm`](#sympy.polys.matrices.ddm.DDM.to_sdm "sympy.polys.matrices.ddm.DDM.to_sdm")
...
返回一个[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")表示的*自我*。
...
[`to_ddm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm"), [`to_dense`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dense "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dense"), [`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")

```py
to_dfm_or_ddm()
```

返回一个[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")或[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")表示的*自我*。

解释

如果地面类型是`flint`且地面域受到`python-flint`支持，则可以使用[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")表示。如果可能，此方法将返回一个[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")表示，否则将返回一个[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")表示。
...
[`to_ddm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm")

总是返回一个[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")表示。

[`to_dfm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm")

返回一个[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")表示或引发错误。

[`to_dense`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dense "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dense")

内部转换为[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")或[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")。

[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")

[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")密集的FLINT矩阵表示。

[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")

Python [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")密集域矩阵表示。

```py
to_dod()
```

将[`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix")转换为字典格式的字典（dod）。
...
[`from_dod`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_dod "sympy.polys.matrices.domainmatrix.DomainMatrix.from_dod"), [`from_dod_like`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_dod_like "sympy.polys.matrices.domainmatrix.DomainMatrix.from_dod_like"), [`to_dok`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok"), [`to_list`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_list "sympy.polys.matrices.domainmatrix.DomainMatrix.to_list"), [`to_list_flat`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat "sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat"), [`to_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz"), [`sympy.matrices.matrixbase.MatrixBase.todod`](../matrices/matrices.html#sympy.matrices.matrixbase.MatrixBase.todod "sympy.matrices.matrixbase.MatrixBase.todod")

```py
to_dok()
```

将 [`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix") 转换为键列表（DOK）格式的字典。
...
虽然重构的矩阵始终处于稀疏格式，但可以通过调用 [`from_dok()`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_dok "sympy.polys.matrices.domainmatrix.DomainMatrix.from_dok") 来重建矩阵：
...
[`from_dok`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_dok "sympy.polys.matrices.domainmatrix.DomainMatrix.from_dok"), [`to_list`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_list "sympy.polys.matrices.domainmatrix.DomainMatrix.to_list"), [`to_list_flat`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat "sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat"), [`to_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz")
...
将 [`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix") 转换为非零元素和数据的列表。

解释

返回一个元组 `(elements, data)`，其中 `elements` 是矩阵元素的列表，可能不包括零。可以通过将这些元素传递给 [`from_flat_nz()`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz") 来重构矩阵。其思想是能够修改元素的平面列表，然后在相同位置创建具有修改元素的相同形状的新矩阵。

`data`的格式取决于底层表示是密集还是稀疏的，但无论如何它都以一种方式表示列表中元素的位置，[`from_flat_nz()`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz")可以使用这种方式重构矩阵。[`from_flat_nz()`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz")方法应在调用[`to_flat_nz()`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz")的同一个[`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix")上调用。
...
[`from_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz")

```py
to_list()
```

将[`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix")转换为列表的列表。

参见

[`from_list`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_list "sympy.polys.matrices.domainmatrix.DomainMatrix.from_list"), [`to_list_flat`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat "sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat"), [`to_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz"), [`to_dok`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok")

```py
to_list_flat()
```

将[`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix")转换为平坦列表。
...
[`from_list_flat`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_list_flat "sympy.polys.matrices.domainmatrix.DomainMatrix.from_list_flat"), [`to_list`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_list "sympy.polys.matrices.domainmatrix.DomainMatrix.to_list"), [`to_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz"), [`to_dok`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok")

```py
to_sdm()
```

返回*self*的[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")表示。
...
[`to_ddm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm"), [`to_sparse`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_sparse "sympy.polys.matrices.domainmatrix.DomainMatrix.to_sparse"), [`sympy.polys.matrices.sdm.SDM.to_ddm`](#sympy.polys.matrices.sdm.SDM.to_ddm "sympy.polys.matrices.sdm.SDM.to_ddm")

```py
to_sparse()
```

返回*self*的稀疏DomainMatrix表示。
...
[`convert_to`](#sympy.polys.matrices.domainmatrix.DomainMatrix.convert_to "sympy.polys.matrices.domainmatrix.DomainMatrix.convert_to"), [`to_dense`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dense "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dense"), [`to_sparse`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_sparse "sympy.polys.matrices.domainmatrix.DomainMatrix.to_sparse")
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.diag`](#sympy.polys.matrices.domainmatrix.DomainMatrix.diag "sympy.polys.matrices.domainmatrix.DomainMatrix.diag")
...
从字典字典（dod）格式创建 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")。
...
[`to_dod`](#sympy.polys.matrices.ddm.DDM.to_dod "sympy.polys.matrices.ddm.DDM.to_dod"), [`sympy.polys.matrices.sdm.SDM.from_dod`](#sympy.polys.matrices.sdm.SDM.from_dod "sympy.polys.matrices.sdm.SDM.from_dod"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.from_dod`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_dod "sympy.polys.matrices.domainmatrix.DomainMatrix.from_dod")

```py
classmethod from_dok(dok, shape, domain)
```

从字典键（dok）格式创建 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")。
...
[`to_dok`](#sympy.polys.matrices.ddm.DDM.to_dok "sympy.polys.matrices.ddm.DDM.to_dok"), [`sympy.polys.matrices.sdm.SDM.from_dok`](#sympy.polys.matrices.sdm.SDM.from_dok "sympy.polys.matrices.sdm.SDM.from_dok"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.from_dok`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_dok "sympy.polys.matrices.domainmatrix.DomainMatrix.from_dok")

```py
classmethod from_flat_nz(elements, data, domain)
```

在调用 [`to_flat_nz()`](#sympy.polys.matrices.ddm.DDM.to_flat_nz "sympy.polys.matrices.ddm.DDM.to_flat_nz") 后重构 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")。
...
[`to_flat_nz`](#sympy.polys.matrices.ddm.DDM.to_flat_nz "sympy.polys.matrices.ddm.DDM.to_flat_nz"), [`sympy.polys.matrices.sdm.SDM.from_flat_nz`](#sympy.polys.matrices.sdm.SDM.from_flat_nz "sympy.polys.matrices.sdm.SDM.from_flat_nz"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz")

```py
classmethod from_list(rowslist, shape, domain)
```

从列表列表创建 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")。
...
[`from_list_flat`](#sympy.polys.matrices.ddm.DDM.from_list_flat "sympy.polys.matrices.ddm.DDM.from_list_flat")

```py
classmethod from_list_flat(flat, shape, domain)
```

从一个扁平元素列表创建 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")。
...
[`to_list_flat`](#sympy.polys.matrices.ddm.DDM.to_list_flat "sympy.polys.matrices.ddm.DDM.to_list_flat"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.from_list_flat`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_list_flat "sympy.polys.matrices.domainmatrix.DomainMatrix.from_list_flat")

```py
hstack(*B)
```

水平堆叠 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM") 矩阵。
...
说这个矩阵是否是对角线的。即使矩阵不是方的，也可以返回True。

```py
is_lower()
```

说这个矩阵是否是下三角形的。即使矩阵不是方的，也可以返回True。

```py
is_upper()
```

说这个矩阵是否是上三角形的。即使矩阵不是方的，也可以返回True。
...
[`iter_values`](#sympy.polys.matrices.ddm.DDM.iter_values "sympy.polys.matrices.ddm.DDM.iter_values")，[`to_dok`](#sympy.polys.matrices.ddm.DDM.to_dok "sympy.polys.matrices.ddm.DDM.to_dok")，[`sympy.polys.matrices.domainmatrix.DomainMatrix.iter_items`](#sympy.polys.matrices.domainmatrix.DomainMatrix.iter_items "sympy.polys.matrices.domainmatrix.DomainMatrix.iter_items")
...
[`iter_items`](#sympy.polys.matrices.ddm.DDM.iter_items "sympy.polys.matrices.ddm.DDM.iter_items")，[`to_list_flat`](#sympy.polys.matrices.ddm.DDM.to_list_flat "sympy.polys.matrices.ddm.DDM.to_list_flat")，[`sympy.polys.matrices.domainmatrix.DomainMatrix.iter_values`](#sympy.polys.matrices.domainmatrix.DomainMatrix.iter_values "sympy.polys.matrices.domainmatrix.DomainMatrix.iter_values")
...
[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM") 矩阵中的非零条目数。

参见

[`sympy.polys.matrices.domainmatrix.DomainMatrix.nnz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.nnz "sympy.polys.matrices.domainmatrix.DomainMatrix.nnz")
...
[`rref`](#sympy.polys.matrices.ddm.DDM.rref "sympy.polys.matrices.ddm.DDM.rref")，[`sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace`](#sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace "sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace")
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace`](#sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace "sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace")
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.rref`](#sympy.polys.matrices.domainmatrix.DomainMatrix.rref "sympy.polys.matrices.domainmatrix.DomainMatrix.rref")
...
矩阵a的行简化阶梯形式，带分母和主元列表

参见

[`sympy.polys.matrices.domainmatrix.DomainMatrix.rref_den`](#sympy.polys.matrices.domainmatrix.DomainMatrix.rref_den "sympy.polys.matrices.domainmatrix.DomainMatrix.rref_den")
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.scc`](#sympy.polys.matrices.domainmatrix.DomainMatrix.scc "sympy.polys.matrices.domainmatrix.DomainMatrix.scc")
...
转换为 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")。

仅返回 `self`，以与其他矩阵类型如 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 中对应方法保持一致。

请参阅

[`to_sdm`](#sympy.polys.matrices.ddm.DDM.to_sdm "sympy.polys.matrices.ddm.DDM.to_sdm"), [`to_dfm`](#sympy.polys.matrices.ddm.DDM.to_dfm "sympy.polys.matrices.ddm.DDM.to_dfm"), [`to_dfm_or_ddm`](#sympy.polys.matrices.ddm.DDM.to_dfm_or_ddm "sympy.polys.matrices.ddm.DDM.to_dfm_or_ddm"), [`sympy.polys.matrices.sdm.SDM.to_ddm`](#sympy.polys.matrices.sdm.SDM.to_ddm "sympy.polys.matrices.sdm.SDM.to_ddm"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_ddm")

```py
to_dfm()
```

将 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM") 转换为 [`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")。
...
[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM"), [`sympy.polys.matrices._dfm.DFM.to_ddm`](#sympy.polys.matrices._dfm.DFM.to_ddm "sympy.polys.matrices._dfm.DFM.to_ddm")

```py
to_dfm_or_ddm()
```

如果可能，转换为 [`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")，否则返回自身。
...
[`to_dfm`](#sympy.polys.matrices.ddm.DDM.to_dfm "sympy.polys.matrices.ddm.DDM.to_dfm"), [`to_ddm`](#sympy.polys.matrices.ddm.DDM.to_ddm "sympy.polys.matrices.ddm.DDM.to_ddm"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm")
...
[`from_dod`](#sympy.polys.matrices.ddm.DDM.from_dod "sympy.polys.matrices.ddm.DDM.from_dod"), [`sympy.polys.matrices.sdm.SDM.to_dod`](#sympy.polys.matrices.sdm.SDM.to_dod "sympy.polys.matrices.sdm.SDM.to_dod"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod")

```py
to_dok()
```

将 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM") 转换为键值对（dok）格式。
...
[`from_dok`](#sympy.polys.matrices.ddm.DDM.from_dok "sympy.polys.matrices.ddm.DDM.from_dok"), [`sympy.polys.matrices.sdm.SDM.to_dok`](#sympy.polys.matrices.sdm.SDM.to_dok "sympy.polys.matrices.sdm.SDM.to_dok"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dok")
...
该方法用于操作矩阵元素列表，然后使用[`from_flat_nz()`](#sympy.polys.matrices.ddm.DDM.from_flat_nz "sympy.polys.matrices.ddm.DDM.from_flat_nz")重构矩阵。列表中包括零元素，但将来可能会发生变化。
...
[`from_flat_nz`](#sympy.polys.matrices.ddm.DDM.from_flat_nz "sympy.polys.matrices.ddm.DDM.from_flat_nz"), [`sympy.polys.matrices.sdm.SDM.to_flat_nz`](#sympy.polys.matrices.sdm.SDM.to_flat_nz "sympy.polys.matrices.sdm.SDM.to_flat_nz"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz")
...
[`to_list_flat`](#sympy.polys.matrices.ddm.DDM.to_list_flat "sympy.polys.matrices.ddm.DDM.to_list_flat"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_list`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_list "sympy.polys.matrices.domainmatrix.DomainMatrix.to_list")
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat "sympy.polys.matrices.domainmatrix.DomainMatrix.to_list_flat")

```py
to_sdm()
```

转换为[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")。
...
[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM"), [`sympy.polys.matrices.sdm.SDM.to_ddm`](#sympy.polys.matrices.sdm.SDM.to_ddm "sympy.polys.matrices.sdm.SDM.to_ddm")

```py
vstack(*B)
```

垂直堆叠[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")矩阵。
...
用于在列表列表矩阵表示中操作矩阵的ddm_*例程的模块。

这些例程在DDM类内部使用，该类还为它们提供了更友好的接口。这里的思路是以一种可以应用于任何简单列表表示的核心矩阵例程的方式实现，而无需使用特定的矩阵类。例如，我们可以计算类似以下矩阵的RREF：
...
DDM类是使用这些例程的下一级，但它们包装了一个处理复制等操作的接口，并跟踪矩阵元素的域：
...
TypeVar(‘R’, bound=[`RingElement`](#sympy.polys.matrices._typing.RingElement "sympy.polys.matrices._typing.RingElement")) 的别名
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.charpoly`](#sympy.polys.matrices.domainmatrix.DomainMatrix.charpoly "sympy.polys.matrices.domainmatrix.DomainMatrix.charpoly")
...
[https://en.wikipedia.org/wiki/Samuelson%E2%80%93Berkowitz_algorithm](https://en.wikipedia.org/wiki/Samuelson%E2%80%93Berkowitz_algorithm)
...
域 \(K\) 必须支持精确除法 (`K.exquo`)。这种方法适用于大多数精确环和域，如 [ZZ](domainsref.html#zz)，[QQ](domainsref.html#qq) 和 [QQ<a>](domainsref.html#qq-a)，但不适用于不精确的域，如 [RR](domainsref.html#rr) 和 [CC](domainsref.html#cc)。
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.det`](#sympy.polys.matrices.domainmatrix.DomainMatrix.det "sympy.polys.matrices.domainmatrix.DomainMatrix.det")

参考文献

[[R776](#id8)]

[https://en.wikipedia.org/wiki/Bareiss_algorithm](https://en.wikipedia.org/wiki/Bareiss_algorithm)

[[R777](#id9)]

[https://www.math.usm.edu/perry/Research/Thesis_DRL.pdf](https://www.math.usm.edu/perry/Research/Thesis_DRL.pdf)
...
[`ddm_irref`](#sympy.polys.matrices.dense.ddm_irref "sympy.polys.matrices.dense.ddm_irref")
...
在原地计算矩阵的LU分解。返回执行的行交换列表。

使用基域中的除法，这个域应该是一个精确的域。

这只适用于像 [GF(p)](domainsref.html#gf-p)，[QQ](domainsref.html#qq)，[QQ_I](domainsref.html#qq-i) 和 [QQ<a>](domainsref.html#qq-a) 这样的域。对于像 [K(x)](domainsref.html#id11) 这样的有理函数域，最好清除分母并使用无除法的算法。为避免精确零点，使用枢轴选取，但不适用于浮点精度，因此 [RR](domainsref.html#rr) 和 [CC](domainsref.html#cc) 不适合（请使用 [`ddm_irref()`](#sympy.polys.matrices.dense.ddm_irref "sympy.polys.matrices.dense.ddm_irref") 替代）。
...
[`ddm_irref`](#sympy.polys.matrices.dense.ddm_irref "sympy.polys.matrices.dense.ddm_irref"), [`ddm_ilu_solve`](#sympy.polys.matrices.dense.ddm_ilu_solve "sympy.polys.matrices.dense.ddm_ilu_solve"), [`sympy.matrices.matrixbase.MatrixBase.LUdecomposition`](../matrices/matrices.html#sympy.matrices.matrixbase.MatrixBase.LUdecomposition "sympy.matrices.matrixbase.MatrixBase.LUdecomposition")
...
[`ddm_ilu`](#sympy.polys.matrices.dense.ddm_ilu "sympy.polys.matrices.dense.ddm_ilu")

Compute the LU decomposition of a matrix in place.

[`ddm_ilu_split`](#sympy.polys.matrices.dense.ddm_ilu_split "sympy.polys.matrices.dense.ddm_ilu_split")

Compute the LU decomposition of a matrix and separate \(L\) and \(U\).

[`sympy.polys.matrices.domainmatrix.DomainMatrix.lu_solve`](#sympy.polys.matrices.domainmatrix.DomainMatrix.lu_solve "sympy.polys.matrices.domainmatrix.DomainMatrix.lu_solve")
...
[`ddm_ilu`](#sympy.polys.matrices.dense.ddm_ilu "sympy.polys.matrices.dense.ddm_ilu"), [`ddm_ilu_solve`](#sympy.polys.matrices.dense.ddm_ilu_solve "sympy.polys.matrices.dense.ddm_ilu_solve")
...
This routine is only really suitable for use with simple field domains like [GF(p)](domainsref.html#gf-p), [QQ](domainsref.html#qq) and [QQ<a>](domainsref.html#qq-a) although even for [QQ](domainsref.html#qq) with larger matrices it is possibly more efficient to use fraction free approaches.

This method is not suitable for use with rational function fields ([K(x)](domainsref.html#id11)) because the elements will blowup leading to costly gcd operations. In this case clearing denominators and using fraction free approaches is likely to be more efficient.

For inexact numeric domains like [RR](domainsref.html#rr) and [CC](domainsref.html#cc) pass `_partial_pivot=True` to use partial pivoting to control rounding errors.
...
[`ddm_irref_den`](#sympy.polys.matrices.dense.ddm_irref_den "sympy.polys.matrices.dense.ddm_irref_den")

这一例程的无分数版本。

[`sdm_irref`](#sympy.polys.matrices.sdm.sdm_irref "sympy.polys.matrices.sdm.sdm_irref")
...
[https://en.wikipedia.org/wiki/Row_echelon_form#Reduced_row_echelon_form](https://en.wikipedia.org/wiki/Row_echelon_form#Reduced_row_echelon_form)
...
所使用的算法是高斯-约当消元的无分数版本，简称为FFGJ，见[[R779]](#r779)。这里修改过以处理零或丢失的主元，并避免冗余算术。

域 \(K\) 必须支持精确的除法（`K.exquo`），但不需要是一个域。此方法适用于大多数精确的环和域，如 [ZZ](domainsref.html#zz), [QQ](domainsref.html#qq) 和 [QQ<a>](domainsref.html#qq-a)。对于 [QQ](domainsref.html#qq) 或 [K(x)](domainsref.html#id11)，清除分母并使用 [ZZ](domainsref.html#zz) 或 [K[x]](domainsref.html#k-x) 可能更有效。

对于 [RR](domainsref.html#rr) 和 [CC](domainsref.html#cc) 等非精确域，请使用 `ddm_irref`。
...
[`ddm_irref()`](#sympy.polys.matrices.dense.ddm_irref "sympy.polys.matrices.dense.ddm_irref")的稀疏版本。

[`sdm_rref_den`](#sympy.polys.matrices.sdm.sdm_rref_den "sympy.polys.matrices.sdm.sdm_rref_den")

[`ddm_irref_den()`](#sympy.polys.matrices.dense.ddm_irref_den "sympy.polys.matrices.dense.ddm_irref_den")的稀疏版本。
...
线性和多项式方程的无分数算法。George C. Nakos，Peter R. Turner，Robert M. Williams。[https://dl.acm.org/doi/10.1145/271130.271133](https://dl.acm.org/doi/10.1145/271130.271133)
...
为了创建一个新的[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")，需要一个将非零元素映射到它们在矩阵中相应行和列的字典的字典。

我们还需要指定我们[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")对象的形状和[`Domain`](domainsref.html#sympy.polys.domains.domain.Domain "sympy.polys.domains.domain.Domain")。

如下所示，我们声明一个属于QQ域的2x2 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 矩阵。示例中的2x2矩阵是
...
我们可以像操作矩阵类一样操作[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")
...
添加两个[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")矩阵
...
返回[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")矩阵的特征多项式的系数。这些元素将是域元素。元素的域与[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")的域相同。
...
我们可以使用系数创建多项式，使用[`Poly`](reference.html#sympy.polys.polytools.Poly "sympy.polys.polytools.Poly")。
...
将[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")矩阵的[`Domain`](domainsref.html#sympy.polys.domains.domain.Domain "sympy.polys.domains.domain.Domain")转换为K
...
返回[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")对象的副本
...
返回指定域大小x大小的单位[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")矩阵
...
从[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")创建[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")。
...
[`to_ddm`](#sympy.polys.matrices.sdm.SDM.to_ddm "sympy.polys.matrices.sdm.SDM.to_ddm"), [`from_list`](#sympy.polys.matrices.sdm.SDM.from_list "sympy.polys.matrices.sdm.SDM.from_list"), [`from_list_flat`](#sympy.polys.matrices.sdm.SDM.from_list_flat "sympy.polys.matrices.sdm.SDM.from_list_flat"), [`from_dok`](#sympy.polys.matrices.sdm.SDM.from_dok "sympy.polys.matrices.sdm.SDM.from_dok")

```py
classmethod from_dod(dod, shape, domain)
```

从字典（dod）格式的字典创建[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")。
...
[`to_dod`](#sympy.polys.matrices.sdm.SDM.to_dod "sympy.polys.matrices.sdm.SDM.to_dod"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod")

```py
classmethod from_dok(dok, shape, domain)
```

从键（dok）格式的字典创建[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")。
...
[`to_dok`](#sympy.polys.matrices.sdm.SDM.to_dok "sympy.polys.matrices.sdm.SDM.to_dok"), [`from_list`](#sympy.polys.matrices.sdm.SDM.from_list "sympy.polys.matrices.sdm.SDM.from_list"), [`from_list_flat`](#sympy.polys.matrices.sdm.SDM.from_list_flat "sympy.polys.matrices.sdm.SDM.from_list_flat"), [`from_ddm`](#sympy.polys.matrices.sdm.SDM.from_ddm "sympy.polys.matrices.sdm.SDM.from_ddm")

```py
classmethod from_flat_nz(elements, data, domain)
```

在调用 [`to_flat_nz()`](#sympy.polys.matrices.sdm.SDM.to_flat_nz "sympy.polys.matrices.sdm.SDM.to_flat_nz") 后重建 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")。

参见 [`to_flat_nz()`](#sympy.polys.matrices.sdm.SDM.to_flat_nz "sympy.polys.matrices.sdm.SDM.to_flat_nz") 的解释。

参见

[`to_flat_nz`](#sympy.polys.matrices.sdm.SDM.to_flat_nz "sympy.polys.matrices.sdm.SDM.to_flat_nz"), [`from_list_flat`](#sympy.polys.matrices.sdm.SDM.from_list_flat "sympy.polys.matrices.sdm.SDM.from_list_flat"), [`sympy.polys.matrices.ddm.DDM.from_flat_nz`](#sympy.polys.matrices.ddm.DDM.from_flat_nz "sympy.polys.matrices.ddm.DDM.from_flat_nz"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.from_flat_nz")

```py
classmethod from_list(ddm, shape, domain)
```

从列表的列表创建 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 对象。
...
> [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 矩阵的维度

**域:**

> 表示 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 对象的 [`Domain`](domainsref.html#sympy.polys.domains.domain.Domain "sympy.polys.domains.domain.Domain")。

返回:

包含 ddm 元素的 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")。
...
[`to_list`](#sympy.polys.matrices.sdm.SDM.to_list "sympy.polys.matrices.sdm.SDM.to_list"), [`from_list_flat`](#sympy.polys.matrices.sdm.SDM.from_list_flat "sympy.polys.matrices.sdm.SDM.from_list_flat"), [`from_dok`](#sympy.polys.matrices.sdm.SDM.from_dok "sympy.polys.matrices.sdm.SDM.from_dok"), [`from_ddm`](#sympy.polys.matrices.sdm.SDM.from_ddm "sympy.polys.matrices.sdm.SDM.from_ddm")

```py
classmethod from_list_flat(elements, shape, domain)
```

从元素的扁平列表创建 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")。
...
[`to_list_flat`](#sympy.polys.matrices.sdm.SDM.to_list_flat "sympy.polys.matrices.sdm.SDM.to_list_flat"), [`from_list`](#sympy.polys.matrices.sdm.SDM.from_list "sympy.polys.matrices.sdm.SDM.from_list"), [`from_dok`](#sympy.polys.matrices.sdm.SDM.from_dok "sympy.polys.matrices.sdm.SDM.from_dok"), [`from_ddm`](#sympy.polys.matrices.sdm.SDM.from_ddm "sympy.polys.matrices.sdm.SDM.from_ddm")

```py
hstack(*B)
```

水平堆叠 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 矩阵。
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.iter_items`](#sympy.polys.matrices.domainmatrix.DomainMatrix.iter_items "sympy.polys.matrices.domainmatrix.DomainMatrix.iter_items")

```py
iter_values()
```

遍历[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 矩阵的非零值。
...
返回矩阵[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 的LLL-简化基础。
...
返回[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 矩阵的负数
...
一个[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 对象
...
[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 矩阵中非零元素的数量。
...
矩阵[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") A 的零空间。

矩阵的定义必须是一个字段。

最好使用 [`nullspace()`](#sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace "sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace") 方法，而不是这个已不再使用的方法。
...
返回[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 矩阵 `A` 的零空间。
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace_from_rref`](#sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace_from_rref "sympy.polys.matrices.domainmatrix.DomainMatrix.nullspace_from_rref")

这个函数的更高级直接等效。

[`sympy.polys.matrices.ddm.DDM.nullspace_from_rref`](#sympy.polys.matrices.ddm.DDM.nullspace_from_rref "sympy.polys.matrices.ddm.DDM.nullspace_from_rref")

稠密 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM") 矩阵的等效函数。

```py
rref()
```

返回带有分母和主元列表的 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")
...
减去两个 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 矩阵
...
将 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 对象转换为 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM") 对象
...
将 [`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM") 对象转换为 [`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM") 对象
...
[`to_ddm`](#sympy.polys.matrices.sdm.SDM.to_ddm "sympy.polys.matrices.sdm.SDM.to_ddm"), [`to_dfm_or_ddm`](#sympy.polys.matrices.sdm.SDM.to_dfm_or_ddm "sympy.polys.matrices.sdm.SDM.to_dfm_or_ddm"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm")

```py
to_dfm_or_ddm()
```

如果可能，转换为 [`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")，否则为 [`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")。
...
[`to_ddm`](#sympy.polys.matrices.sdm.SDM.to_ddm "sympy.polys.matrices.sdm.SDM.to_ddm"), [`to_dfm`](#sympy.polys.matrices.sdm.SDM.to_dfm "sympy.polys.matrices.sdm.SDM.to_dfm"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm")
...
[`from_dod`](#sympy.polys.matrices.sdm.SDM.from_dod "sympy.polys.matrices.sdm.SDM.from_dod"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dod")
...
[`from_dok`](#sympy.polys.matrices.sdm.SDM.from_dok "sympy.polys.matrices.sdm.SDM.from_dok"), [`to_list`](#sympy.polys.matrices.sdm.SDM.to_list "sympy.polys.matrices.sdm.SDM.to_list"), [`to_list_flat`](#sympy.polys.matrices.sdm.SDM.to_list_flat "sympy.polys.matrices.sdm.SDM.to_list_flat"), [`to_ddm`](#sympy.polys.matrices.sdm.SDM.to_ddm "sympy.polys.matrices.sdm.SDM.to_ddm")

```py
to_flat_nz()
```

将[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")转换为非零元素和数据的平坦列表。

解释

用于操作矩阵元素列表，然后使用[`from_flat_nz()`](#sympy.polys.matrices.sdm.SDM.from_flat_nz "sympy.polys.matrices.sdm.SDM.from_flat_nz")在相同位置重构修改后的矩阵。列表中省略了零元素。
...
[`from_flat_nz`](#sympy.polys.matrices.sdm.SDM.from_flat_nz "sympy.polys.matrices.sdm.SDM.from_flat_nz"), [`to_list_flat`](#sympy.polys.matrices.sdm.SDM.to_list_flat "sympy.polys.matrices.sdm.SDM.to_list_flat"), [`sympy.polys.matrices.ddm.DDM.to_flat_nz`](#sympy.polys.matrices.ddm.DDM.to_flat_nz "sympy.polys.matrices.ddm.DDM.to_flat_nz"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz "sympy.polys.matrices.domainmatrix.DomainMatrix.to_flat_nz")

```py
to_list()
```

将一个[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")对象转换为一个列表的列表。
...
将[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")转换为平坦列表。
...
[`from_list_flat`](#sympy.polys.matrices.sdm.SDM.from_list_flat "sympy.polys.matrices.sdm.SDM.from_list_flat"), [`to_list`](#sympy.polys.matrices.sdm.SDM.to_list "sympy.polys.matrices.sdm.SDM.to_list"), [`to_dok`](#sympy.polys.matrices.sdm.SDM.to_dok "sympy.polys.matrices.sdm.SDM.to_dok"), [`to_ddm`](#sympy.polys.matrices.sdm.SDM.to_ddm "sympy.polys.matrices.sdm.SDM.to_ddm")

```py
to_sdm()
```

将[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")格式转换为自身。

```py
transpose()
```

返回一个[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")矩阵的转置。
...
垂直堆叠[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")矩阵。
...
返回指定域的大小为形状的[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")。

在下面的示例中，我们声明一个矩阵A，其中，
...
伯克维兹算法是一种在任何可交换环上计算矩阵特征多项式的无除算法，仅使用系数环中的算术运算。该实现适用于以字典格式表示的稀疏矩阵（例如[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")）。
...
[`sympy.polys.matrices.dense.ddm_berk`](#sympy.polys.matrices.dense.ddm_berk "sympy.polys.matrices.dense.ddm_berk")
...
与[`MutableDenseMatrix`](../matrices/dense.html#sympy.matrices.dense.MutableDenseMatrix "sympy.matrices.dense.MutableDenseMatrix")类似的计算会是
...
此算法的成本完全由矩阵中非零元素决定。在该算法的任何步骤中，成本都不依赖于矩阵的行数或列数。甚至不依赖于非零行数，除了主要的循环。该实现比稀疏矩阵的ddm_rref快得多。事实上，甚至在输入为完全密集矩阵时，它也比密集实现稍微快一些，因此似乎在所有情况下都更快。
...
所用算法是高斯-约旦消元的无分数版本，被描述为FFGJ，详见[[R781]](#r781)。这里对其进行了修改，以处理零或缺失的主元，并避免冗余运算。此实现还针对稀疏矩阵进行了优化。

域\(K\)必须支持精确除法（`K.exquo`），但不必是一个字段。对大多数精确环和类似[ZZ](domainsref.html#zz)、[QQ](domainsref.html#qq)和[QQ<a>](domainsref.html#qq-a)的域来说，此方法是合适的。在[QQ](domainsref.html#qq)或[K(x)](domainsref.html#id11)的情况下，清除分母并使用[ZZ](domainsref.html#zz)或[K[x]](domainsref.html#k-x)可能更有效。

对于[RR](domainsref.html#rr)和[CC](domainsref.html#cc)等不精确域，请改用`ddm_irref`。
...
[`sympy.polys.matrices.matrices.domainmatrix.DomainMatrix.rref_den`](#sympy.polys.matrices.matrices.domainmatrix.DomainMatrix.rref_den "sympy.polys.matrices.matrices.domainmatrix.DomainMatrix.rref_den")
...
稠密的FLINT矩阵。这个类是Python-FLINT中矩阵的包装器。
...
通常情况下，DFM类不会直接实例化，而是作为[`DomainMatrix`](#sympy.polys.matrices.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.matrices.domainmatrix.DomainMatrix")的内部表示创建。当\(SYMPY_GROUND_TYPES\)设置为\(flint\)并安装了\(python-flint\)时，如果域受到python-flint支持，将自动使用[`DFM`](#sympy.polys.matrices.matrices._dfm.DFM "sympy.polys.matrices.matrices._dfm.DFM")类作为[`DomainMatrix`](#sympy.polys.matrices.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.matrices.domainmatrix.DomainMatrix")的稠密格式内部表示。
...
通过调用[`to_dfm()`](#sympy.polys.matrices._dfm.DFM.to_dfm "sympy.polys.matrices._dfm.DFM.to_dfm")方法，[`DomainMatrix`](#sympy.polys.matrices.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.matrices.domainmatrix.DomainMatrix")可以转换为[`DFM`](#sympy.polys.matrices.matrices._dfm.DFM "sympy.polys.matrices.matrices._dfm.DFM")：
...
调用底层FLINT矩阵的`.charpoly()`方法。

对于[ZZ](domainsref.html#zz)或[QQ](domainsref.html#qq)，这将分别调用`fmpz_mat_charpoly`或`fmpq_mat_charpoly`。

在编写时，`fmpq_mat_charpoly`清除整个矩阵的分母，然后调用`fmpz_mat_charpoly`。特征多项式的系数然后乘以分母的幂。

`fmpz_mat_charpoly`方法使用带有CRT重建的模块化算法。模块化算法使用`nmod_mat_charpoly`，它对小矩阵和非素数模或者Danilevsky方法。
...
对于[ZZ](domainsref.html#zz)或[QQ](domainsref.html#qq)，分别调用`fmpz_mat_det`或`fmpq_mat_det`。

在编写时，`fmpz_mat_det`的实现根据矩阵的大小和条目的比特大小使用多种算法。使用的算法有：

+   对于非常小的矩阵（最多4x4），伴随矩阵。

+   小矩阵（最多25x25）的Bareiss算法。

+   对于较大的矩阵（最多60x60）或具有大比特大小的较大矩阵的模块化算法。

+   对于更大的矩阵（60x60及以上），如果比特大小小于矩阵的尺寸，则采用模块化的“加速”方法。
...
[`to_dod()`](#sympy.polys.matrices._dfm.DFM.to_dod "sympy.polys.matrices._dfm.DFM.to_dod")的逆运算。
...
[`to_flat_nz()`](#sympy.polys.matrices._dfm.DFM.to_flat_nz "sympy.polys.matrices._dfm.DFM.to_flat_nz")的逆运算。
...
[`to_list_flat()`](#sympy.polys.matrices._dfm.DFM.to_list_flat "sympy.polys.matrices._dfm.DFM.to_list_flat")的逆运算。
...
目前，如果域是[ZZ](domainsref.html#zz)，这将引发错误，但将使用[QQ](domainsref.html#qq)的FLINT方法。

对于 [ZZ](domainsref.html#zz) 和 [QQ](domainsref.html#qq)，FLINT 方法分别是 `fmpz_mat_inv` 和 `fmpq_mat_inv`。`fmpz_mat_inv` 方法计算带有分母的逆矩阵。这是通过调用 `fmpz_mat_solve` 实现的（有关算法的说明，请参见 [`lu_solve()`](#sympy.polys.matrices._dfm.DFM.lu_solve "sympy.polys.matrices._dfm.DFM.lu_solve") 中的注释）。

`fmpq_mat_inv` 方法会从每行清除分母，然后将其乘到 rhs 单位矩阵中，最后调用 `fmpz_mat_solve`。

另请参见

[`sympy.polys.matrices.domainmatrix.DomainMatrix.inv`](#sympy.polys.matrices.domainmatrix.DomainMatrix.inv "sympy.polys.matrices.domainmatrix.DomainMatrix.inv")
...
有关更多信息，请参阅 [`lll_transform()`](#sympy.polys.matrices._dfm.DFM.lll_transform "sympy.polys.matrices._dfm.DFM.lll_transform")。
...
[`sympy.polys.matrices.domainmatrix.DomainMatrix.lll`](#sympy.polys.matrices.domainmatrix.DomainMatrix.lll "sympy.polys.matrices.domainmatrix.DomainMatrix.lll")

更高级的接口，用于计算 LLL 简化基。

[`lll_transform`](#sympy.polys.matrices._dfm.DFM.lll_transform "sympy.polys.matrices._dfm.DFM.lll_transform")
...
[`lll`](#sympy.polys.matrices._dfm.DFM.lll "sympy.polys.matrices._dfm.DFM.lll")
...
目前，如果域是 [ZZ](domainsref.html#zz)，则会引发错误，但会使用 [QQ](domainsref.html#qq) 的 FLINT 方法。

对于 [ZZ](domainsref.html#zz) 和 [QQ](domainsref.html#qq)，FLINT 方法分别是 `fmpz_mat_solve` 和 `fmpq_mat_solve`。`fmpq_mat_solve` 方法使用其中两种算法之一：

+   对于小矩阵（<25 行），它会在矩阵和 rhs 之间清除分母，并使用 `fmpz_mat_solve`。

+   对于较大的矩阵，它使用 `fmpq_mat_solve_dixon`，这是一种在 [QQ](domainsref.html#qq) 上的模块化方法，带有 CRT 重构。
...
转换为[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")。

此[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")方法存在于[`DDM`](#sympy.polys.matrices.ddm.DDM "sympy.polys.matrices.ddm.DDM")和[`SDM`](#sympy.polys.matrices.sdm.SDM "sympy.polys.matrices.sdm.SDM")方法的并行之中。对于[`DFM`](#sympy.polys.matrices._dfm.DFM "sympy.polys.matrices._dfm.DFM")，它将始终返回自身。

另见

[`to_ddm`](#sympy.polys.matrices._dfm.DFM.to_ddm "sympy.polys.matrices._dfm.DFM.to_ddm"), [`to_sdm`](#sympy.polys.matrices._dfm.DFM.to_sdm "sympy.polys.matrices._dfm.DFM.to_sdm"), [`sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm`](#sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm "sympy.polys.matrices.domainmatrix.DomainMatrix.to_dfm_or_ddm")
...
返回矩阵\(m\)在环\(domain\)上的Smith正规形式。仅当环是主理想域时才起作用。
...
计算[`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix") *A* 在[ZZ](domainsref.html#zz)上的Hermite正规形式。

参数：

**A**：\(m \times n\)在[ZZ](domainsref.html#zz)上的`DomainMatrix`。

**D**：[ZZ](domainsref.html#zz)，可选

> 设\(W\)为*A*的HNF。如果预先已知，可以提供任意多个\(\det(W)\)的正整数*D*。在这种情况下，如果*A*也具有秩\(m\)，那么我们可以使用一个工作于模*D*下的替代算法，以防止系数爆炸。

**check_rank**：布尔值，可选（默认为False）

> 基本假设是，如果你为*D*传递了一个值，那么你已经相信*A*的秩为\(m\)，因此我们不会浪费时间为你检查它。如果你确实希望进行检查（并且在检查失败时使用普通的、非模*D*算法），请将*check_rank*设置为`True`。

返回：

[`DomainMatrix`](#sympy.polys.matrices.domainmatrix.DomainMatrix "sympy.polys.matrices.domainmatrix.DomainMatrix")
...
> 如果矩阵的域不是 [ZZ](domainsref.html#zz)，或者给定的 *D* 不在 [ZZ](domainsref.html#zz) 中。
