...
+   一旦构造了COO数组，可以转换为CSR或CSC格式进行快速算术和矩阵向量操作
...
[`shape`](https://docs.scipy.org/doc/scipy-1.12.0/reference/generated/scipy.sparse.coo_array.shape.html#scipy.sparse.coo_array.shape "scipy.sparse.coo_array.shape")2元组
