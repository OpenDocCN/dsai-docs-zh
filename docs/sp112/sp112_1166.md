...
> 原文链接：[`docs.scipy.org/doc/scipy-1.12.0/reference/generated/scipy.stats.laplace.html#scipy.stats.laplace`](https://docs.scipy.org/doc/scipy-1.12.0/reference/generated/scipy.stats.laplace.html#scipy.stats.laplace)
...
作为`rv_continuous`类的一个实例，`laplace`对象继承了一组通用方法（下面列出了完整列表），并用特定于此特定分布的细节来完善它们。
...
![../../_images/scipy-stats-laplace-1.png](img/4788fb9bef0006243340993fd9a43311.png)
